		...
		<Link className="navbar-brand" to="/">Start</Link>
		 <ul className="navbar-nav mr-auto">
			...
			<div className="form-inline my-2 my-lg-0">
				...
				var self = this;
				this.props.mainContainer.login(self.state.username,self.state.password);
				}}>Login</button>
			...
			<div className="form-inline my-2 my-lg-0">
				...
				this.props.mainContainer.logout(); }}>log out</button>
				<span className="navbar-nav nav-item active">
					<Link className="nav-link" to={"/user/"+this.props.mainContainer.state.loggedUser.id}>{this.props.mainContainer.state.loggedUser.name}</Link>
				</span>
			</div>}
